using Platy.CSharp.Extensions;

namespace Platy.CSharp.Extensions.Tests.Attributes;

public enum ApiLevel
{
  [DisplayAttribute("private")] Private = 1,
  [DisplayAttribute("public")] Public = 2,
  [DisplayAttribute("corporate")] Corporate = 3
}

[Flags]
public enum UserType
{
  [DisplayAttribute("admin")] Admin = 1,
  [DisplayAttribute("editor")] Editor = 2,
  [DisplayAttribute("publisher")] Publisher = 3,
  [DisplayAttribute("all")] All = Admin | Editor | Publisher
}
